...
UCBPatrolRigDebugVisualizer::UCBPatrolRigDebugVisualizer(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
...
FDebugRenderSceneProxy* UCBPatrolRigDebugVisualizer::CreateDebugSceneProxy()
{
