...
#include "CBEnemyPatrolRigComponent.generated.h"

class ACBEnemyCharacterBase;
class UCBPatrolRigDebugVisualizer;
...
class CB_API UCBEnemyPatrolRigComponent : public USceneComponent
{
	GENERATED_BODY()

public:	
	UCBEnemyPatrolRigComponent();
...
public:	
	...
	TSubclassOf<ACBEnemyCharacterBase> EnemyToSpawn;
	...
	UPROPERTY(BlueprintReadOnly, EditAnywhere, meta = (Category = "CB"))
	FEnemyInitializationArgs EnemyInitArgs;
...
protected:
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly)
	TObjectPtr<UCBPatrolRigDebugVisualizer> Visualizer;
#endif
};
