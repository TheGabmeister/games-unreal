...
#include "CBPatrolRigDebugVisualizer.generated.h"
...
class CB_API UCBPatrolRigDebugVisualizer : public UDebugDrawComponent
{
	GENERATED_BODY()
...
public:
	// Default constructor 
	UCBPatrolRigDebugVisualizer(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
