#include "DiabloEditorToolWidget.h"
...
void UDiabloEditorToolWidget::GenerateAllAssets()
{
...
void UDiabloEditorToolWidget::GenerateInputAssets()
{
...
bool UDiabloEditorToolWidget::CreateBlueprintFromClass(UClass* ParentClass, const FString& AssetPath, const FString& AssetName)
{
...
bool UDiabloEditorToolWidget::SaveAsset(UObject* Asset, UPackage* Package, const FString& PackagePath)
{
...
void UDiabloEditorToolWidget::NotifyAssetCreated(UObject* Asset)
{
