---
name: ue5-animate
description: Author procedural animations for the UE5 Mannequin skeleton via blender_anim.py. Use when the user asks to create, modify, or preview character animations.
---
