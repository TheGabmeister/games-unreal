...
namespace
{
	...
	static bool MutableContainsToken(const FString& Source, std::initializer_list<const TCHAR*> Tokens)
	{
	...
	{
		return MutableContainsToken(ClassName, {TEXT("CustomizableObject"), TEXT("Mutable")});
	}
		...
		TArray<FString>* OutReferenceValues = nullptr)
	{
		...
		for (TFieldIterator<FProperty> It(Object->GetClass()); It; ++It)
		{
			...
			const bool bInteresting = bIncludeAllSimpleProperties ||
				MutableContainsToken(PropertyName, {
	...
	{
		return MutableContainsToken(ClassName, {TEXT("Parameter")}) || MutableContainsToken(Title, {TEXT("Parameter")});
	}

	static FString DeriveNodeRole(const FString& ClassName, const FString& Title)
	{
		if (MutableContainsToken(ClassName, {TEXT("Projector")}) || MutableContainsToken(Title, {TEXT("Projector")}))
		{
			return TEXT("projector");
		}
		if (MutableContainsToken(ClassName, {TEXT("ObjectGroup")}) || MutableContainsToken(Title, {TEXT("Object Group")}))
		{
			return TEXT("object_group");
		}
		if (MutableContainsToken(ClassName, {TEXT("Table")}) || MutableContainsToken(Title, {TEXT("Table")}))
		{
			return TEXT("table");
		}
		if (MutableContainsToken(ClassName, {TEXT("Output")}) || MutableContainsToken(Title, {TEXT("Output")}))
		{
			return TEXT("output");
		}
	...
	{
		if (MutableContainsToken(ClassName, {TEXT("Bool")}) || MutableContainsToken(Title, {TEXT("Bool"), TEXT("Toggle")}))
		{
			return TEXT("bool");
		}
		if (MutableContainsToken(ClassName, {TEXT("Int")}) || MutableContainsToken(Title, {TEXT("Int")}))
		{
			return TEXT("int");
		}
		if (MutableContainsToken(ClassName, {TEXT("Float"), TEXT("Scalar")}) || MutableContainsToken(Title, {TEXT("Float"), TEXT("Scalar")}))
		{
			return TEXT("float");
		}
		if (MutableContainsToken(ClassName, {TEXT("Color")}) || MutableContainsToken(Title, {TEXT("Color")}))
		{
			return TEXT("color");
		}
		if (MutableContainsToken(ClassName, {TEXT("Projector")}) || MutableContainsToken(Title, {TEXT("Projector")}))
		...
		if (MutableContainsToken(ClassName, {TEXT("Texture"), TEXT("Image")}) || MutableContainsToken(Title, {TEXT("Texture"), TEXT("Image")}))
		{
			return TEXT("texture");
		}
		if (MutableContainsToken(ClassName, {TEXT("Enum")}) || MutableContainsToken(Title, {TEXT("Enum")}))
		{
			return TEXT("enum");
		}
		return TEXT("unknown");
	...
	static FString DeriveParameterBehavior(const FString& ClassName, const FString& Title, const TSharedPtr<FJsonObject>& Properties)
	{
		...
		if (MutableContainsToken(CombinedHints, {TEXT("OneOrNone")}))
		{
			return TEXT("one_or_none");
		}
		if (MutableContainsToken(CombinedHints, {TEXT("Toggle"), TEXT("Bool")}))
		{
			return TEXT("toggle");
		}
		if (MutableContainsToken(CombinedHints, {TEXT("Overlay")}))
		{
			return TEXT("overlay");
		}
		if (MutableContainsToken(CombinedHints, {TEXT("Projector")}))
		{
			return TEXT("projector");
		}
		if (MutableContainsToken(CombinedHints, {TEXT("Group"), TEXT("Slot")}))
		{
			return TEXT("slot");
		}
		return TEXT("select");
	...
	for (const TPair<FString, TSharedPtr<FJsonObject>>& Pair : GraphData.NodeByPath)
	{
		...
		for (const FString& ConnectedPath : ConnectedNodes)
		{
			...
			if (const TSharedPtr<FJsonObject>* ConnectedNode = GraphData.NodeByPath.Find(ConnectedPath))
			{
				...
				if (MutableContainsToken(ConnectedClass, {TEXT("Compatible"), TEXT("Constraint")}))
				{
					AddUniqueString(CompatibilityLinks, ConnectedPath);
				}
				if (MutableContainsToken(ConnectedClass, {TEXT("Exclusive"), TEXT("Incompatible")}))
				{
